...
tie_build_theme_option(
	array(
		'title' => esc_html__( 'Dark Skin', TIELABS_TEXTDOMAIN ),
		'id'    => 'styling-head',
		'type'  => 'header',
	));
...
tie_build_theme_option(
	array(
		...
		'id'   => 'system_skin',
		'hint' => esc_html__( 'This option requires the "Light/Dark Skin Switcher" option in the Header Settings to be enabled.', TIELABS_TEXTDOMAIN ),
		'type' => 'checkbox',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Slide Sidebar Skin', TIELABS_TEXTDOMAIN ),
		'id'     => 'side_aside_skin',
		'type'   => 'radio',
		'options' => array(
			'dark'  => esc_html__( 'Dark Skin', TIELABS_TEXTDOMAIN ),
			'light' => esc_html__( 'Light Skin', TIELABS_TEXTDOMAIN ),
		)));
