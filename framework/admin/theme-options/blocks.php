...
tie_build_theme_option(
	array(
		...
		'toggle' => array(
			'2' => '',
			'1' => "#blocks_shadow-item",
			'3' => "#blocks_shadow-item",
		)));

tie_build_theme_option(
	array(
		'name'  => esc_html__( 'Block Shadow', TIELABS_TEXTDOMAIN ),
		'id'    => 'blocks_shadow',
		'type'  => 'checkbox',
		'class' => 'boxes_style',
	));
...
tie_build_theme_option(
	...
	if( $get_taxonomies = TIELABS_ADMIN_HELPER::get_taxonomies() ){
		tie_build_theme_option(
			array(
				'title' =>	esc_html__( 'Custom Post Types', TIELABS_TEXTDOMAIN ),
				'id'    =>	'blocks-custom-post-types-settings',
				'type'  => 'header',
			));

		tie_build_theme_option(
			array(
				'name'    => esc_html__( 'Custom Post Types', TIELABS_TEXTDOMAIN ),
